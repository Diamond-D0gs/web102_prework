...
const unfundedGamesCount = GAMES_JSON.reduce((acc, game) => acc += game.pledged < game.goal ? 1 : 0, 0);

// create a string that explains the number of unfunded games using the ternary operator
const description = `A total of ${(100_000).toLocaleString("en-US")} has been raised for 4 games. Currently, ${unfundedGamesCount}
    ${unfundedGamesCount == 1 ? "game remains" : "games remain"} unfunded. We need your help to fund ${unfundedGamesCount == 1 ? "this amazing game" : "these amazing games"}.`
